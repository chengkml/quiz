...
public class ExamServiceImpl implements ExamService {
    ...
    public Page<ExamDto> searchExams(ExamQueryDto queryDto) {
        ...
        List<ExamDto> exams = jdbcTemplate.query(listSql, params, (rs, rowNum) -> {
            ...
            dto.setSubjectId(rs.getString("subject_id")); // 设置学科ID
    ...
    """);
        ...
        List<ExamResultHistoryItemDto> results = jdbcTemplate.query(listSql, params, (rs, rowNum) -> {
            ...
            dto.setTotalScore(rs.getInt("total_score"));
            dto.setUserScore(rs.getInt("user_score"));
    ...
    @Override
    @Transactional
    public ExamDto autoGenerateExam(ExamAutoGenerateDto autoGenerateDto) {
        ...
        if (!StringUtils.hasText(subjectId)) {
            throw new RuntimeException("学科不能为空");
        }
        ...
        String sql = """
                ...
                WHERE 1=1 AND k.subject_id = :subjectId
                """;
        Map<String, Object> params = new HashMap<>();
