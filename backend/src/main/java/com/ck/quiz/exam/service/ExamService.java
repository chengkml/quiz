...
public interface ExamService {
     ...
     * 一键智能生成试卷
     *
     * @param autoGenerateDto 生成试卷的配置参数
     * @return 自动生成的试卷信息
     */
    ExamDto autoGenerateExam(com.ck.quiz.exam.dto.ExamAutoGenerateDto autoGenerateDto);
     ...
     */
    void generateReviewExam(String userId, String subjectId);
}