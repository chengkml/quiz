package com.ck.quiz.funcdoc.entity;
...
@Entity
@Table(
        name = "func_doc_heading",
        indexes = {
                @Index(name = "idx_func_doc_heading_doc_id", columnList = "doc_id"),
                @Index(name = "idx_func_doc_heading_level", columnList = "heading_level"),
                @Index(name = "idx_func_doc_heading_order_no", columnList = "order_no")
        }
)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class FuncDocHeading {
