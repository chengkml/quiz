...
@Table(
        name = "func_doc",
        indexes = {
                @Index(name = "idx_func_doc_file_name", columnList = "file_name"),
                @Index(name = "idx_func_doc_upload_user", columnList = "upload_user"),
                @Index(name = "idx_func_doc_upload_time", columnList = "upload_time")
        }
)
@Data
@NoArgsConstructor
