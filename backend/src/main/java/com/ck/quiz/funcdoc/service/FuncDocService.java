package com.ck.quiz.funcdoc.service;
 ...
 * 定义文档管理的核心业务操作
 */
public interface FuncDocService {
     ...
     * @return 创建的文档信息
     */
    FuncDocDto createDocInfo(FuncDocCreateDto createDto);
     ...
     * @return 文档信息
     */
    FuncDocDto uploadDocFile(MultipartFile file);
     ...
     * @return 文档信息
     */
    FuncDocDto getDocInfoById(String id);
     ...
     * @return 分页文档列表
     */
    Page<FuncDocDto> pageDocInfo(FuncDocQueryDto queryDto);
     ...
     * @return 文档标题树列表
     */
    List<FuncDocHeadingTreeDto> getDocHeadingTree(String docId);
     ...
     * @return 流程节点分页结果
     */
    Page<FuncDocProcessNodeDto> pageDocProcessNode(FuncDocProcessNodeQueryDto queryDto);
