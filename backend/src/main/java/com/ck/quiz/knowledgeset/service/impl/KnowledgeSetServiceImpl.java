...
@Service
public class KnowledgeSetServiceImpl extends
        BaseServiceImpl<KnowledgeSetCreateDto, KnowledgeSetUpdateDto, KnowledgeSetQueryDto, KnowledgeSetDto, KnowledgeSet, KnowledgeSetRepository>
        implements KnowledgeSetService {
    ...
    public KnowledgeSetDto update(String userId, KnowledgeSetUpdateDto updateDto) {
        ...
        if (updateDto.getName() != null
                && repository.existsByNameAndCreateUserAndIdNot(updateDto.getName(), userId, updateDto.getId())) {
            throw new DuplicateKeyException("知识集名称已存在");
        }
    ...
    public void delete(String userId, String id) {
        KnowledgeSet model = repository.findById(id).orElse(null);
