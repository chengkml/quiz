...
public class MenuController {
    ...
    public ResponseEntity getMenuById(
            @Parameter(description = "菜单ID", required = true) @PathVariable("menuId") String menuId) {
    ...
    public ResponseEntity getMenuByName(
            @Parameter(description = "菜单名称", required = true) @PathVariable("menuName") String menuName) {
    ...
    public ResponseEntity searchMenus(
            @Parameter(description = "菜单名称") @RequestParam(value = "menuName", required = false) String menuName,
            @Parameter(description = "菜单类型") @RequestParam(value = "menuType", required = false) Menu.MenuType menuType,
            @Parameter(description = "父菜单ID") @RequestParam(value = "parentId", required = false) String parentId,
            @Parameter(description = "菜单状态") @RequestParam(value = "state", required = false) Menu.MenuState state,
            ...
            @Parameter(description = "排序字段") @RequestParam(value = "sortColumn", defaultValue = "seq") String sortColumn,
            @Parameter(description = "排序方向") @RequestParam(value = "sortType", defaultValue = "asc") String sortType) {
