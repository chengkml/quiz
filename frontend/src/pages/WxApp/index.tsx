...
function WxAppManager() {
  ...
  // 当前记录与弹窗
  const [currentRecord, setCurrentRecord] = useState<WxAppResponse | null>(
    null
  );
    ...
    <div className="wxapp-manager">
      ...
      >
        <div className="delete-modal">
          ...
          {currentRecord && <p>小程序名称：{currentRecord.appName}</p>}
        </div>
      </Modal>
    </div>
  );
