  ...
  const handleSend = async () => {
    try {
      ...
      const payload: any = {
        ...
        attachments:
          channel === 'EMAIL'
            ? fileList.map((it: any) => it.originFile || it.file).filter(Boolean)
            : undefined,
      };
      ...
      <div className="notification-container">
        <Card className="notification-card" bordered>
          <div className="header">
            ...
            <Radio.Group value={channel} onChange={(val: ChannelType) => setChannel(val)}>
          ...
          <Form ref={formRef} layout="vertical" className="notification-form">
