...
import { Button, Card, Message, Result, Space } from '@arco-design/web-react';
import { IconCheckCircle } from '@arco-design/web-react/icon';
import { useNavigate } from 'react-router-dom';
import { getDueToday, reviewKnowledge, KnowledgeDto } from './api';
...
const ReviewPage: React.FC<ReviewPageProps> = ({ embedded = false, onExit }) => {
    ...
    const [cards, setCards] = useState<KnowledgeDto[]>([]);
    ...
    const handleScore = async (score: number) => {
        ...
        try {
            setReviewing(true);
            const res = await reviewKnowledge({
                id: currentCard.id,
                score
            });
                    ...
                    >
                        ...
                        <div className="card-face card-back">
                            <div
                                ...
                                dangerouslySetInnerHTML={{ __html: currentCard.content || '暂无内容' }}
                            />
                        </div>
                    </Card>
                </div>
