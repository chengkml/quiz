...
import { Table, Message, Button, Space, Tag } from '@arco-design/web-react';
  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      render: (_: any, record: ExamHistoryItemDto) => (
        <Space>
          <Button type="primary" size="small" icon={<IconEye />} onClick={() => navigate(`/quiz/frame/exam/result/${record.resultId}`)}>查看详情</Button>
        </Space>
      )
    }
  ], [navigate]);
